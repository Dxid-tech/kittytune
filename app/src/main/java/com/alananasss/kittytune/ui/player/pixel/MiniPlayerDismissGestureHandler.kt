...
/**
 * PixelPlayer-accurate swipe-to-dismiss gesture handler for MiniPlayer.
 * Features:
 * - 4 drag phases (IDLE, TENSION, SNAPPING, FREE_DRAG)
 * - Rubber-band tension up to 100dp drag (max 30dp offset)
 * - Haptic snap trigger at 100dp with smooth spring snap
 * - Responsive 1:1 free drag
 * - Commit offscreen (>40% screen width) with 200ms FastOutSlowInEasing or bounce-back spring
 */
